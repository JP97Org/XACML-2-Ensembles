...
public class ValueDeclaration implements ScalaCode {
     ...
     * 
     * @return the standard value, which is {@code null} for non-primitive types and {@code 0} for
     *         Int and Double.
     */
    private String getStandardValue() {
        return this.type.equals(ScalaHelper.KEYWORD_INT) || this.type.equals(ScalaHelper.KEYWORD_DOUBLE) ? " = 0"
                : " = null";
    }
